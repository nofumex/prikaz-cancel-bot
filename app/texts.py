...
def welcome_text(company_name: str) -> str:
    return (
        ...
        "4. после оплаты получите полный комплект документов и инструкцию.\n\n"
...
def payment_text(case, price: int) -> str:
    ...
    return (
        ...
        "После оплаты вы сразу получите полный DOCX, полный PDF и инструкцию по отправке в суд.\n\n"
...
def deadline_warning(deadline: date | None, reminder_no: int) -> str:
    ...
    return (
        f"<b>Напоминание {reminder_no}/3</b>\n\n"
        "Ваше заявление уже подготовлено, но полный вариант еще не оплачен.\n"
        f"{tail}\n\n"
